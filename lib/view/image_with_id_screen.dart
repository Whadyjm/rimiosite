...
class _ImageWithIdScreenState extends State<ImageWithIdScreen> {
  ...
  Future<void> galeriaPicker() async {
    ...
    Uint8List _bytes = await _imageWithId!.readAsBytes();
                    ...
                    onTap: () async {
                      ...
                      if (formKey.currentState!.validate()) {
                        try {
                          ...
                          Uint8List imageId = Base64Codec().decode(base64String);
                          await refId.putData(imageId, SettableMetadata(contentType: 'image/jpg'));
                          userImageWithId = await refId.getDownloadURL();
                          //profile
                          ...
                          var map = widget.body;
                          map['userId'] = uid;
                          map['imageWithId'] = userImageWithId;
